...
public class KafkaConfig {
  ...
  @Bean
  public ConcurrentKafkaListenerContainerFactory<String, MovieCreatedEvent>
      movieKafkaListenerContainerFactory(KafkaConfig config) {
  ...
  public ConcurrentKafkaListenerContainerFactory<String, ShowtimeCreatedEvent>
      showtimeKafkaListenerContainerFactory(KafkaConfig config) {
    return config.createListenerFactory(ShowtimeCreatedEvent.class);
  }

  @Bean
  public ConcurrentKafkaListenerContainerFactory<String, BookingSuccessEvent>
      bookingKafkaListenerContainerFactory(KafkaConfig config) {
